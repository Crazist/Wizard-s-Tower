...
public class AssetProvider
{
    ...
    private const string CharacterConfigsPath = "Configs/CharacterConfigs";
    ...
    public CharacterConfigs CharacterConfigs { get; set; }
    public AssetProvider()
    {
        ...
        CharacterConfigs = Resources.Load<CharacterConfigs>(CharacterConfigsPath);
    }
}